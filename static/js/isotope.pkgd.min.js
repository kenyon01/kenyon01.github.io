		...
		i.docReady(function() {
			...
			h.forEach(function(t) {
				...
				try {
					...
					return void(o && o.error("Error parsing " + r + " on " + t.className +
						": " + a))
				}
				var u = new e(t, i);
				l && l.data(t, n, u)
...
function(t, e) {
	...
	d.constructor = o, d._create = function() {
		...
		r = isNaN(r) ? 0 : r, a = isNaN(a) ? 0 : a, r -= e ? s.paddingLeft : s.paddingRight, a -= i ? s
			.paddingTop : s.paddingBottom, this.position.x = r, this.position.y = a
...
function(t, e) {
	...
	o.extend(c, e.prototype), c.option = function(t) {
		...
		for (var e = this._filterFindItemElements(t), i = this.constructor.Item, o = [], n = 0; n < e
			.length; n++) {
			var s = e[n],
				r = new i(s, this);
			o.push(r)
		...
		return i.defaults = o.extend({}, s.defaults), o.extend(i.defaults, e), i.compatOptions = o.extend({}, s
				.compatOptions), i.namespace = t, i.data = s.data, i.Item = r(n), o.htmlInit(i, t), h && h
...
function(t, e) {
	...
	return o._resetLayout = function() {
		...
		for (var n = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", s =
				this[n](o, t), r = {
		...
		for (var h = this._getOption("originTop"), d = (h ? o.top : o.bottom) + i.outerHeight, l = a; l <=
			u; l++) this.colYs[l] = Math.max(d, this.colYs[l])
