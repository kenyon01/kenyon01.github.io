...
try {
  ...
  Invoke-Checked pnpm exec vitest run --project unit src/lib/services/contents/entry/publication.test.js src/lib/services/contents/draft/save/conflict.test.js src/lib/services/contents/draft/create/index.test.js
